...
class PainterScreen extends StatefulWidget {
  PainterScreen({super.key});

  String id = 'PainterHomepage';
...
class _PainterScreenState extends State<PainterScreen> {
  ...
  final  _future = Supabase.instance.client.from('worker').select<List<Map<String, dynamic>>>().eq('craft', 'Painter');
  @override
  void initState() {
    print(_future);
    super.initState();
